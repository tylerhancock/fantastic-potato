	...
	<div class="container-fluid py-4">
		<div class="row">
			<div class="col-12 col-sm-9 col-md-7 col-lg-5 mx-auto">
				<img class="d-block mx-auto" src="assets/images/doctors.svg" width="100%" alt="">
			</div>
		</div>
		<div class="row pt-4">
			<div class="col-12 col-sm-10 col-lg-7 mx-auto">
				<p class="lead text-center">The Response Fund is helping to provide funding for essential workers during the COVID-19 pandemic.</p>
				<p class="lead text-center">Every cent donated here goes directly to the organizations below to ensure those who keep our lives moving forward receive the support they deserve.</p>
...
<section class="min-vh-100 bg-yellow py-5">
	<div class="container-fluid py-4">
		<div class="row pb-3">
			<div class="col-12">
